...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_AREAZERO_CANTESCAPE]                  = COMPOUND_STRING("You can't run away!\nBattle the POKéMON!{PAUSE_UNTIL_PRESS}"),
};
...
const u16 gNoEscapeStringIds[] =
{
    ...
    [B_MSG_CANT_ESCAPE_SCRIPT]   = STRINGID_AREAZERO_CANTESCAPE,
};
