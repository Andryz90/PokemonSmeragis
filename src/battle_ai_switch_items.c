...
void GetAIPartyIndexes(u32 battler, s32 *firstId, s32 *lastId)
{
    ...
    else if (gBattleTypeFlags & (BATTLE_TYPE_TWO_OPPONENTS | BATTLE_TYPE_TOWER_LINK_MULTI)
          || (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER && IsOnPlayerSide(battler)))
    {
