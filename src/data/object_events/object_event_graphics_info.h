...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TeracrystalSmall = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TERACRYSTAL_SMALL,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
    ...
    .subspriteTables = sOamTables_16x16,
    .anims = sAnimTable_BreakableRock,
    .images = sPicTable_TeracrystalSmall,
    .affineAnims = gDummySpriteAffineAnimTable,
};
