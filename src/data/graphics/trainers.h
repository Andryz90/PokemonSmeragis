...
const u8 gTrainerBackPic_Andry[] = INCBIN_U8("graphics/trainers/back_pics/andry.4bpp");
...
const u16 gTrainerBackPicPalette_Wally[] = INCBIN_U16("graphics/trainers/palettes/wally.gbapal");
const u16 gTrainerBackPicPalette_Andry[] = INCBIN_U16("graphics/trainers/back_pics/andry.gbapal");
...
const struct SpriteFrameImage gTrainerBackPicTable_Andry[] =
{
    {gTrainerBackPic_Andry + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Andry + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Andry + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Andry + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_WALLY, 4, gTrainerBackPic_Wally, gTrainerBackPicTable_Wally, gTrainerBackPicPalette_Wally, sBackAnims_Hoenn),
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_ANDRY, 4, gTrainerBackPic_Andry, gTrainerBackPicTable_Andry, gTrainerBackPicPalette_Andry, sBackAnims_Hoenn),
};
