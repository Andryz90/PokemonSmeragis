...
function calculateBWXY(gen, attacker, defender, move, field) {
    ...
    var type1Effectiveness = (0, util_2.getMoveEffectiveness)(gen, move, defender.types[0], isGhostRevealed, field.isGravity, undefined, attacker.hasAbility('Corrosion'));
    var type2Effectiveness = defender.types[1]
        ? (0, util_2.getMoveEffectiveness)(gen, move, defender.types[1], isGhostRevealed, field.isGravity, undefined, attacker.hasAbility('Corrosion'))
        : 1;
